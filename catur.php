...
.square {
 ...
 <body> 
 <center>
     <font Size="3" Color="red">Chess V1.0<br>Code  By Tn.Error404</font>
 </center>
  <div id="container"></div> 
 
<script type="text/javascript" id="dcoder_script">window.onload = function(){
