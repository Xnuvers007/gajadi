...
<font face="Iceland" color="black" size="5"><b >Input URL Target:</b><br><input type="text" class="form-control text-danger"  name="url"  autocomplete="off" placeholder="https://fbi.gov/"></font><br>
    <input type="submit" class="btn btn-outline-info" name="submit" value="Check Now!!!"/>
</form><br>
<p>Result:</p>
<?php
