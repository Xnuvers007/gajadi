...
<br><br><center><form method="GET">
    ...
    <center><h3>Auto Visitor Blog</h3><hr></center>
    <br><br>
<input type="text" class="con7" name="url" value="https://target.com">
